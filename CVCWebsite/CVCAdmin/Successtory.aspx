<%@ Page Title="" Language="C#" MasterPageFile="~/CVCAdmin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Successtory.aspx.cs" Inherits="CVCWebsite.CVCAdmin.Successtory" %>
...
tr:nth-child(even) {
    background-color: #dddddd;
      ...
      <h2 style="text-align: center" >Sucess Story</h2>
    <br /><br />
 ...
 <%-- <tr>
  ...
  <tr>
     <td class="auto-style2" style="border: 2px solid  #00c6d7;">
        <asp:Label ID="Label4" runat="server" Text="Sucess Story"></asp:Label></td>
    <td style="border: 2px solid   #00c6d7;">
